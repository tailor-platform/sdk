import { $tailor_resolver_step__kyselyStep } from "../resolvers/stepChain.js";
...
globalThis.main = await $tailor_sql_step_wrapper("my-db", $tailor_resolver_step__kyselyStep);