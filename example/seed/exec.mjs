...
const namespaceDeps = {
  "tailordb": {
    ...
    "PurchaseOrderChangeRequest": ["PurchaseOrder"],
    "PurchaseOrderChangeStep": ["PurchaseOrderChangeRequest"],
    "PurchaseOrderChangeApproval": ["PurchaseOrderChangeRequest"],
    "PurchaseOrderChangeReworkEvent": ["PurchaseOrderChangeRequest"],
