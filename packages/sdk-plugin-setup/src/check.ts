...
import { currentContentHash } from "./managed";
    ...
    findings.push({
      ...
      message:
        state.currentHash === null
          ...
          : `SDK-managed parts of ${target.file} (tailor-* jobs/steps or top-level keys) were ` +
            "edited by hand. Revert them, or re-run setup with --force to reset them; your own " +
            "jobs and steps are kept.",
    });
  }
