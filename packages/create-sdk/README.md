...
| `executor`             | Executor trigger types           | Record, resolver, schedule, webhook triggers   |
...
- Integration tests with `runWorkflowLocally()`

### executor

Demonstrates every executor trigger type with supporting infrastructure.

**Includes:**

- Record created and updated, resolver executed, schedule, and incoming webhook triggers
- `function`, `graphql`, `webhook`, and `workflow` operation kinds
- Vitest setup
