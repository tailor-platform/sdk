...
${mapFields}
  ...
  return ml /* ts */ `
// This file is auto-generated by @tailor-platform/tailor-sdk
...
export async function generateUserTypes(
  ...
  try {
    ...
    if (!attributeMap && !attributeList) {
      console.log("ℹ️  No attributes found in configuration.");
      return;
    }
...
function resolvePackageDirectory(startDir: string): string | null {
  ...
  try {
    const resolved = require.resolve(
      "@tailor-platform/tailor-sdk/package.json",
      {
        paths: [startDir],
      },
    );
