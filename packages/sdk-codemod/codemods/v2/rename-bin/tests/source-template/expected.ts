...
const placeholderCollision = "tailor deploy --arg \"tailor-sdk deploy\" __TAILOR_SDK_SOURCE_VALUE_0_0__";
const pathQualifiedCliRenameCommand = "./node_modules/.bin/tailor-sdk apply";
const help = "tailor --help";
const optionHelp = "tailor --env-file .env --help";
const optionVersion = "tailor --profile dev --version";
