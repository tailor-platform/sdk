...
const secretValueApplySpawned = spawn("tailor", ["secret", "create", "--value", "apply"]);
const secretShortValueApplySpawned = spawn("tailor", ["secret", "create", "-v", "apply"]);
...
const pnpmDlxWorkspaceRootSpawned = spawn("pnpm", ["-w", "dlx", "@tailor-platform/sdk", "login"]);
...
const windowsShimArgSpawned = spawn("tailor.cmd", ["--arg", "tailor-sdk deploy", "deploy"]);
const pathQualifiedWindowsShimArgSpawned = spawn("./node_modules/.bin/tailor.cmd", ["--arg", "tailor-sdk deploy", "deploy"]);
