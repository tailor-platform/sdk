...
`;
      ...
      expect(result).toContain(
        'tailor.workflow.startWorkflow("my-workflow", { id: 1 }, __tailor_normalizeTriggerOptions(opts))',
      );
    });
...
`;
      ...
      expect(result).toContain(
        'tailor.workflow.startWorkflow("my-workflow", { id: 1 }, __tailor_normalizeTriggerOptions({}))',
      );
    });
