...
vi.mock("#src/cli/commands/tailordb/migrate/config", () => ({
...
vi.mock("#src/cli/commands/tailordb/migrate/snapshot", async (importOriginal) => {
  const original =
    // eslint-disable-next-line @typescript-eslint/consistent-type-imports
    (await importOriginal()) as typeof import("#src/cli/commands/tailordb/migrate/snapshot");
  return {
    ...original,
...
import { reconstructSnapshotFromMigrations } from "#src/cli/commands/tailordb/migrate/snapshot";
