...
import { z } from "zod";
import { configArg, confirmationArgs } from "#src/cli/shared/args";
...
import { getConfiguredEditorCommand, openInConfiguredEditor } from "#src/cli/shared/editor";
...
export async function generate(options: GenerateOptions): Promise<void> {
  ...
  const { defineApplication } = await import("#src/cli/services/application");
