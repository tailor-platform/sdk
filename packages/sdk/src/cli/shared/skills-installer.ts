 ...
 * @param options.source - npm spec or path of the skill bundle to install
 * @param options.agent - Optional agent label forwarded as `--agent`
 * @param options.yes - When true, pass `--yes` to skip interactive prompts
