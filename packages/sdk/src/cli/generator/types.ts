 ...
 * For user-defined types, filePath points to the source file.
 * For plugin-generated types, filePath is empty and pluginId is set.
 */
export interface TypeSourceInfoEntry {
  /** File path to import from (empty for plugin-generated types) */
  filePath: string;
  /** Export name in the source file */
  exportName: string;
  /** Plugin ID if generated by a plugin */
  pluginId?: string;
  /** Plugin import path for code generators (e.g., "@tailor-platform/sdk/changeset-plugin") */
  pluginImportPath?: string;
  /** Original type's file path (for plugin-generated types) */
