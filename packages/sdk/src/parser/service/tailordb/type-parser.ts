 ...
 * For plugin-generated types, `filePath` points to the generated file in `.tailor-sdk/types/`,
 * and `originalFilePath`/`originalExportName` preserve the reference to the source type.
 */
export type TypeSourceInfo = Record<
  string,
  {
    /** File path for imports. For plugin-generated types, this is the generated file path. */
    filePath: string;
    /** Export name of the type */
    exportName: string;
    /** Plugin ID if the type was generated by a plugin */
    pluginId?: string;
    /** Original file path (for plugin-generated types, points to the source type's file) */
