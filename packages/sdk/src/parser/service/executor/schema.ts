...
export const TailorDBTriggerSchema = z
  .object({
...
export const ResolverExecutedTriggerSchema = z
  .object({
...
export const IncomingWebhookTriggerResponseSchema = z
  .object({
...
export const IncomingWebhookTriggerSchema = z
  .object({
...
export const IdpUserTriggerSchema = z
  .object({
...
export const AuthAccessTokenTriggerSchema = z
  .object({
...
export const WebhookOperationSchema = z
  .object({
    ...
    headers: z
      .record(
        z.string(),
        z.union([z.string(), z.object({ vault: z.string(), key: z.string() }).strict()]),
      )
      .optional()
