...
describe("getGeneratedType", () => {
  ...
  describe("namespace plugin", () => {
    it("onNamespaceDefine is called only once per namespace during resolution", async () => {
      fs.writeFileSync(
        configPath,
  ...
  onNamespaceDefine({ pluginConfig, namespace }) {
...
`,
      ...
      // onNamespaceDefine for "main" should be called exactly once.
