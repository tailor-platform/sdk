...
describe("getGeneratedType", () => {
  ...
  describe("namespace plugin", () => {
    it("onNamespaceDefined is called only once per namespace during resolution", async () => {
      fs.writeFileSync(
        configPath,
  ...
  onNamespaceDefined({ pluginConfig, namespace }) {
...
`,
      ...
      // onNamespaceDefined for "main" should be called exactly once.
