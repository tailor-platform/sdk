...
| Change decimal scale           | Yes       | Yes               | Auto-generated script re-saves existing rows so stored values are re-serialized under the new scale (platform-gap workaround, not a data transformation)                                                                                         |
