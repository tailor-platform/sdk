...
A domain can be associated with only one environment at a time. To set custom domains only in a specific environment, see [Multi-Environment Configuration](../multi-environment.md#settings-that-belong-to-a-single-environment).
