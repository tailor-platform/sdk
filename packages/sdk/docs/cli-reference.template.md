...
| `PLATFORM_URL`                               | Platform API base URL. Saved into profiles created with `profile create --platform-url`                      |
| `PLATFORM_OAUTH2_CLIENT_ID`                  | OAuth2 client ID for user login. Saved into profiles created with `profile create --oauth2-client-id`        |
| `PLATFORM_CONSOLE_URL`                       | Console base URL. Saved into profiles created with `profile create --console-url`                            |
