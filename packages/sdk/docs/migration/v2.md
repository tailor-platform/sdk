...
## tailor-skills → tailor skills install

**Migration:** Partially automatic

Replace deprecated `tailor-skills` invocations with `tailor skills install`
...
```sh
tailor apply --profile prod
```

After:

```sh
tailor deploy --profile prod
```
