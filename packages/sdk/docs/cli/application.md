...
| `--base-ref <BASE_REF>`         | -     | Override the base ref for --base (implies --base when given without --base). Defaults to auto-detection (GITHUB_BASE_REF, gh PR base, then origin/HEAD). | No       | -                    | -                                 |
