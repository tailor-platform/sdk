...
```bash
$ tailor-sdk executor jobs tailor-sdk executor jobs my-executor
```

**Limit the number of jobs**

```bash
$ tailor-sdk executor jobs tailor-sdk executor jobs my-executor --limit 10
```

**Filter by status**

```bash
$ tailor-sdk executor jobs tailor-sdk executor jobs my-executor -s RUNNING
```

**Get job details**

```bash
$ tailor-sdk executor jobs tailor-sdk executor jobs my-executor <job-id>
```

**Get job details with attempts**

```bash
$ tailor-sdk executor jobs tailor-sdk executor jobs my-executor <job-id> --attempts
```

**Wait for job to complete**

```bash
$ tailor-sdk executor jobs tailor-sdk executor jobs my-executor <job-id> -W
```

**Wait for job with logs**

```bash
$ tailor-sdk executor jobs tailor-sdk executor jobs my-executor <job-id> -W -l
```
...
```bash
$ tailor-sdk executor trigger tailor-sdk executor trigger my-executor
```

**Trigger with data**

```bash
$ tailor-sdk executor trigger tailor-sdk executor trigger my-executor -d '{"message": "hello"}'
```

**Trigger with data and headers**

```bash
$ tailor-sdk executor trigger tailor-sdk executor trigger my-executor -d '{"message": "hello"}' -H "X-Custom: value" -H "X-Another: value2"
```

**Trigger and wait for completion**

```bash
$ tailor-sdk executor trigger tailor-sdk executor trigger my-executor -W
```

**Trigger, wait, and show logs**

```bash
$ tailor-sdk executor trigger tailor-sdk executor trigger my-executor -W -l
```
