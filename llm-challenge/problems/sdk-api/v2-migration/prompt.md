...
The finished workspace should preserve the small customer lookup, workflow launch, workflow orchestration test, runtime file-read, runtime global, configuration, and unit-test surfaces, but should no longer rely on removed or deprecated migration-era patterns.
