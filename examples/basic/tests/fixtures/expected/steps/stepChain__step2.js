import { $tailor_resolver_step__step2 } from "../resolvers/stepChain.transformed.js";
...
globalThis.main = await $tailor_db_wrapper("tailordb", $tailor_resolver_step__step2);