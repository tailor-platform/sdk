...
`;const I={...j};F(`showUserInfo`,I.type({message:I.string()})).fnStep(`step1`,e=>({message:e.input.message,userId:e.user.id,userType:e.user.type})).returns(e=>({message:e.step1.message,userId:e.step1.userId,userType:e.step1.userType}),I.type({message:I.string(),userId:I.string(),userType:I.string()})),globalThis.main=e=>({message:e.input.message,userId:e.user.id,userType:e.user.type});
//# sourceMappingURL=showUserInfo__step1.js.map