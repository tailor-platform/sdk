...
`;const I={...j};F(`showUserInfo`).fnStep(`step1`,e=>({userId:e.user.id,userType:e.user.type})).returns(e=>({userId:e.step1.userId,userType:e.step1.userType}),I.type({userId:I.string(),userType:I.string()})),globalThis.main=e=>({userId:e.user.id,userType:e.user.type});
