...
This directory contains documentation for **SDK developers and contributors**.
...
- [Getting Started](getting-started.md) - Prerequisites, setup, key commands

## Guides

- [Architecture](architecture.md) - Design decisions and non-obvious patterns
